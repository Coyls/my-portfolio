...
export const SmallGobelinsEn = () => (
  <>
    <p>
      ...
      , in a promotion composed of 10 developers and 10 designers.
    </p>
  </>
);
export const GobelinsEn = () => (
  <>
    <p>
      ...
      , in a promo composed of <span className="font-bold">10 developers</span>{" "}
      and <span className="font-bold">10 designers</span>.
    </p>
    <p>
