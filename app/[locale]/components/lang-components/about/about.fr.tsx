export const AboutFr = () => {
  return (
    <>
      <p>
        Je suis actuellement développeur web fullstack, principalement avec
        TypeScript et Next.js. Je me spécialise progressivement en backend et
        DevOps, avec l&apos;envie de mieux comprendre les systèmes, de les
      ...
      <p>
        ...
        un geste, une transition, ou un système bien pensé.
      </p>
    </>
  );
};
