...
export const SmallGobelinsFr = () => (
  <>
    <p>
      Formation en 3 ans, dont 2 en alternance chez{" "}
      <Link href="https://prismo.io/" target="_blank">
        <Button variant="link" className="h-auto p-0 text-sm md:text-base">
          PRISMO
        </Button>
      </Link>
      , dans une promotion composée de 10 développeurs et 10 designers.
    </p>
  </>
);
...
export const GobelinsFr = () => (
  <>
    ...
    <p>
      Très axée <span className="font-bold">projet</span> (environ 50 à 60 % du
      temps), la formation nous a permis de réaliser des objets connectés (
      ...
      <Link href="https://github.com/Coyls/ktk-dataviz-backend" target="_blank">
        <Button variant="link" className="h-auto p-0 text-sm md:text-base">
    ...
    <p>
      Travailler au quotidien avec des designers m’a permis d’affûter mon regard
      sur l’UX et les aspects visuels des projets. Cette proximité m’a aussi
      aidé à gagner en autonomie, à prendre plus d’initiatives et à mieux
